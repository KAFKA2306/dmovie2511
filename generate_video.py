...
async def generate_video(prompt: str, output_path: str = "output.mp4"):
    ...
    with Workflow():
        ...
        latent = KSampler(model, positive=conditioning, negative=conditioning_negative, latent_image=latent, seed=42, steps=20, cfg=7.0, sampler_name="euler", scheduler="normal", denoise=1.0)
